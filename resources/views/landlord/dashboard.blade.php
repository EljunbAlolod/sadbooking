<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-sm font-medium text-indigo-600 uppercase tracking-wider">{{ __('Boarding Hub') }}
                </p>
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div
                            class="p-4 bg-indigo-50 text-indigo-600 rounded-2xl group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('landlord.boarding-houses.index') }}"
                            class="inline-flex items-center gap-1.5 text-xs font-bold text-indigo-600 hover:text-indigo-700 uppercase tracking-wider">
                            {{ __('Manage listings') }}
            ...
            <section class="space-y-6">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('landlord.boarding-houses.create') }}"
                        class="inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-200 transition-all hover:bg-indigo-700 active:scale-95">
                    ...
                    @forelse ($boardingHouses as $house)
                        <article
                            ...
                            <div class="flex flex-1 flex-col gap-4 p-6">
                                <div>
                                    <h4
                                        class="text-lg font-bold text-slate-900 group-hover:text-indigo-600 transition-colors line-clamp-1">
                                        {{ $house->title }}</h4>
                                ...
                                <div class="mt-auto flex items-center gap-3 pt-4 border-t border-slate-100">
                                    <a href="{{ route('landlord.boarding-houses.show', $house) }}"
                                        class="flex-1 inline-flex items-center justify-center rounded-xl bg-indigo-600 px-4 py-2 text-xs font-bold text-white hover:bg-indigo-700 transition-all active:scale-95 shadow-sm shadow-indigo-100">
                                        {{ __('Details') }}
                                    </a>
