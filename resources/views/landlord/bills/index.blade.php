    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('landlord.bills.create') }}">
                <x-primary-button type="button" class="rounded-2xl px-6 py-3 bg-pink-600 hover:bg-pink-700 shadow-lg shadow-pink-200 transition-all active:scale-95">
                                        ...
                                        <div class="flex items-center justify-end gap-3">
                                            @if ($bill->status === \App\Enums\UtilityBillStatus::Unpaid)
                                                <form method="POST" action="{{ route('landlord.bills.paid', $bill) }}" class="inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="inline-flex items-center justify-center rounded-xl bg-pink-600 px-3 py-1.5 text-[10px] font-bold text-white hover:bg-pink-700 transition-all active:scale-95 shadow-lg shadow-pink-100" title="{{ __('Mark as Paid') }}">
                                            ...
                                            <a href="{{ route('landlord.bills.edit', $bill) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-pink-600 hover:border-pink-200 transition-all" title="{{ __('Edit Bill') }}">
