                    ...
                    <div class="group relative bg-white rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-indigo-200 transition-all duration-300 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
                                <a href="{{ route('landlord.boarding-houses.rooms.edit', [$boardingHouse, $room]) }}" class="flex-1 inline-flex justify-center items-center px-4 py-2 bg-slate-900 text-white text-xs font-bold rounded-xl hover:bg-slate-800 transition-colors">
                                    {{ __('Edit Details') }}
                                </a>
