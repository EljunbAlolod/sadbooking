<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-sm font-medium text-pink-600 uppercase tracking-wider">{{ __('Stay Details') }}</p>
                ...
                <div class="p-8 sm:p-10">
                    <div class="grid gap-10 lg:grid-cols-2">
                        ...
                        <div class="space-y-8">
                            <div class="flex items-center gap-6">
                                <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-pink-50 text-pink-600">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center gap-3">
                                        <span class="text-lg font-bold text-pink-600">₱{{ number_format($reservation->room->monthly_rate, 2) }}</span>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex flex-wrap gap-3">
                                @forelse ($reservation->room->amenities as $amenity)
                                    <div class="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl border border-slate-200 bg-white text-sm font-bold text-slate-700 shadow-sm transition-all hover:border-pink-200 hover:bg-pink-50/50">
                    ...
                    @if ($reservation->status === \App\Enums\ReservationStatus::Pending)
                        <div class="mt-12 pt-8 border-t border-slate-100 flex flex-wrap gap-4">
                            <a href="{{ route('tenant.reservations.edit', $reservation) }}" class="inline-flex flex-1 items-center justify-center rounded-2xl border border-slate-200 bg-white px-8 py-4 text-sm font-bold text-slate-700 shadow-sm transition-all hover:border-pink-600 hover:text-pink-600 active:scale-95">
