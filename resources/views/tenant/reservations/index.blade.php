                                ...
                                <tr class="group hover:bg-slate-50/50 transition-colors">
                                    <td class="px-8 py-6 sm:px-10">
                                        <div class="flex items-center gap-4">
                                            <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-pink-50 text-pink-600 group-hover:bg-pink-600 group-hover:text-white transition-colors">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-0.5 text-[10px] font-bold text-pink-600 uppercase tracking-widest">{{ __('Room') }} {{ $reservation->room->room_number }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-6">
                                    ...
                                    <td class="px-6 py-6">
                                        <div class="text-sm font-bold text-pink-600">₱{{ number_format($reservation->room->monthly_rate, 2) }}</div>
                                    </td>
                                    <td class="px-6 py-6">
                                    ...
                                    <td class="px-8 py-6 text-end sm:px-10">
                                        <div class="flex items-center justify-end gap-3">
                                            <a href="{{ route('tenant.reservations.show', $reservation) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-pink-600 hover:border-pink-200 transition-all" title="{{ __('View Details') }}">
                                            ...
                                            @if($reservation->status === \App\Enums\ReservationStatus::Pending)
                                                <a href="{{ route('tenant.reservations.edit', $reservation) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-pink-600 hover:border-pink-200 transition-all" title="{{ __('Edit Dates') }}">
