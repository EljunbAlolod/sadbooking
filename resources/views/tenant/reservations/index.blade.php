                                ...
                                <tr class="group hover:bg-slate-50/50 transition-colors">
                                    <td class="px-8 py-6 sm:px-10">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                                                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    class="mt-0.5 text-[10px] font-bold text-indigo-600 uppercase tracking-widest">
                                    ...
                                    <td class="px-6 py-6">
                                        ...
                                        <div
                                            class="mt-1 text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                                            <svg class="h-3.5 w-3.5 text-slate-400" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <td class="px-6 py-6">
                                        <div class="text-sm font-bold text-indigo-600">
                                            ₱{{ number_format($reservation->room->monthly_rate, 2) }}</div>
                                    </td>
                                    <td class="px-6 py-6">
                                        <span
                                    ...
                                    <td class="px-8 py-6 text-end sm:px-10">
                                        <div class="flex items-center justify-end gap-3">
                                            <a href="{{ route('tenant.reservations.show', $reservation) }}"
                                                class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-indigo-600 hover:border-indigo-200 transition-all"
                                            ...
                                            @if($reservation->status === \App\Enums\ReservationStatus::Pending)
                                                <a href="{{ route('tenant.reservations.edit', $reservation) }}"
                                                    class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-indigo-600 hover:border-indigo-200 transition-all"
                                                    title="{{ __('Edit Dates') }}">
                                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-8 py-20 text-center">
                                        <div
                                            class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-slate-50 text-slate-300 mb-6">
                                        ...
                                        <p class="mt-2 text-sm text-slate-500">
                                            {{ __('You haven\'t made any reservations yet.') }}</p>
                                        <a href="{{ route('boarding-houses.index') }}"
                                            class="mt-8 inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-8 py-4 text-sm font-bold text-white shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all active:scale-95">
